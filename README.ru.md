...
- macOS 14 или новее.
- Установленный Codex CLI. Если CLI не установлен или не авторизован, приложение предложит установить его и выполнить вход.

Codex Desktop с встроенным Codex не заменяет Codex CLI для этого приложения: лимиты читаются через локальный CLI. Установка CLI запускается из приложения официальным установщиком после подтверждения пользователя.
