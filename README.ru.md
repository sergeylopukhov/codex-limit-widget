...
Индикатор в строке меню показывает подробные лимиты или компактный процент. Действие по левому щелчку настраивается: всплывающее окно, настройки или Codex. По правому щелчку открывается меню с обновлением, копированием статуса и выходом; пока идёт обновление, видно, что данные загружаются.
...
Порог предупреждений о низком лимите задаётся в настройках. Тихие часы не показывают такие уведомления в выбранное время; на сообщение о восстановлении лимита они не влияют.
