...
Download `CodexLimitWidget-1.0.1-macOS.dmg` from the latest GitHub Release, open it, and run:
...
```text
release/CodexLimitWidget-1.0.1-macOS.dmg
release/CodexLimitWidget-1.0.1-macOS.zip
```
