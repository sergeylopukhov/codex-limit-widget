...
- Uses one unconditional WidgetKit root view for the removable system background while keeping the selected full-color design inside it.
- Republished the same user-facing version as internal build 152.
